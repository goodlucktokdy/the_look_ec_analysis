...
## 📝 Project Overview
이 프로젝트는 **빅쿼리 퍼블릭 데이터셋인 The Look E-commerce 데이터셋**을 기반으로 고객의 구매 행동을 분석하여 **RFM 세그먼테이션**을 수행하고, 각 세그먼트별 맞춤형 **리텐션(Retention) 전략 및 예상 ROI**를 제안하는 비즈니스 인텔리전스 대시보드입니다.
